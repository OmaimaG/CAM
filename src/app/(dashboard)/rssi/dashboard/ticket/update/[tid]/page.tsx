    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className='mt-6 ml-8'>
        ...
        <textarea
          ...
          name='content'
          value={content}
          className='block p-2.5 w-2/5 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-700 h-45'
      ...
      <label htmlFor="status" className="block mb-2 mt-6 text-sm ml-2 font-medium text-gray-900 dark:text-white">Select Ticket Status</label>
      <select
        id="status"
        name="status"
        value={status}
